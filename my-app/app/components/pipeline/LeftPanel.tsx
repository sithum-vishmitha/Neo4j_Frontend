...
export function LeftPanel({ files, steps, running, onAddFiles, onRemoveFile, onClear, onRun }: LeftPanelProps) {
  ...
  return (
    <div className="flex h-full flex-col border-r border-white/10 bg-[#0B1118]">
        ...
        {tabs.map((tab) => {
          ...
          return (
            <button
              ...
              className={`
              relative flex-1 rounded-t-xl px-4 py-3 text-xs font-semibold tracking-[0.15em]
        ...
        "
            ...
            "
                >
                  ...
                  and graph structures from uploaded PDF documents. Extracted data is
                  transformed into Cypher-compatible graph records and exported as
      ...
      "
          ...
          ">
            ...
            ">
              ...
              {/* Metrics */}
              <div className="relative grid grid-cols-1 gap-4 border-b border-white/10 p-6">
        ...
        ">
              ...
              ${running ? "bg-amber-300 animate-pulse" : "bg-cyan-300"}
            `} />
                    ...
                    running ?
                      (
                        <div className="mt-1 text-xs text-yellow-300">
                          GraphXR visualization is being ready
                        </div>
                      ) : (
      ...
      {/* Bottom Action Bar */}
      <div className="border-t border-white/10 bg-[#0D141D]/95 backdrop-blur-xl p-5">
      ...
      `}
          ...
          ${!running && "group-hover:translate-x-0.5"}
        `}
            >
              {running ? "◌" : "▶"}
            </span>

            {running ? "PROCESSING KNOWLEDGE GRAPH..." : "PROCESS & BUILD KG"}
          </button>
        </div>
      </div>
    </div>
